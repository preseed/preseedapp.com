! function(e, t) {
    ...
    function b(e) {
        var t = J,
            n = _t[e];
        return n || (n = x(e, t), "none" !== n && n || (Rt = (Rt || Z("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Rt[0].contentDocument, t.write(), t.close(), n = x(e, t), Rt.detach()), _t[e] = n), n
    }

    function w(e, t, n) {
        var r, i, o, s, a = e.style;
        return n = n || Bt(e), n && (s = n.getPropertyValue(t) || n[t]), n && ("" !== s || Z.contains(e.ownerDocument, e) || (s = Z.style(e, t)), It.test(s) && Wt.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function F(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = Gt || S(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
    ...
    var it = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : _) !== q && L(t), t = t || q, n = n || [], !e || "string" != typeof e) return n;
            ...
            if (F && !r) {
                ...
                if (w.qsa && (!M || !M.test(e))) {
                    if (d = f = R, h = t, g = 9 === a && e, 1 === a && "object" !== t.nodeName.toLowerCase()) {
        ...
        var b, w, T, C, k, N, E, j, D, S, A, L, q, H, F, M, O, $, P, R = "sizzle" + -new Date,
            _ = e.document,
            W = 0,
            I = 0,
            B = n(),
        ...
        try {
            Z.apply(G = et.call(_.childNodes), _.childNodes), G[_.childNodes.length].nodeType
        } catch (Ct) {
            Z = {
        ...
        w = t.support = {}, k = t.isXML = function(e) {
            ...
            return n !== q && 9 === n.nodeType && n.documentElement ? (q = n, H = n.documentElement, F = !k(n), r && r !== r.top && (r.addEventListener ? r.addEventListener("unload", function() {
                ...
                w.disconnectedMatch = $.call(e, "div"), $.call(e, "[s!='']:x"), O.push("!=", at)
            }), M = M.length && new RegExp(M.join("|")), O = O.length && new RegExp(O.join("|")), t = vt.test(H.compareDocumentPosition), P = t || vt.test(H.contains) ? function(e, t) {
                ...
                return r ? r : (r = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & r || !w.sortDetached && t.compareDocumentPosition(e) === r ? e === n || e.ownerDocument === _ && P(_, e) ? -1 : t === n || t.ownerDocument === _ && P(_, t) ? 1 : S ? tt.call(S, e) - tt.call(S, t) : 0 : 4 & r ? -1 : 1)
            } : function(e, t) {
                if (e === t) return A = !0, 0;
                var r, i = 0,
                    o = e.parentNode,
                ...
                for (; u[i] === l[i];) i++;
                return i ? s(u[i], l[i]) : u[i] === _ ? -1 : l[i] === _ ? 1 : 0
            }, n) : q
        }, t.matches = function(e, n) {
            return t(e, null, null, n)
        }, t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== q && L(e), n = n.replace(ft, "='$1']"), !(!w.matchesSelector || !F || O && O.test(n) || M && M.test(n))) try {
                var r = $.call(e, n);
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (A = !w.detectDuplicates, S = !w.sortStable && e.slice(0), e.sort(U), A) {
    ...
    Z.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (m)
                ...
                }), t = (t || "").match(dt) || [""], l = t.length; l--;) a = St.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = Z.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = Z.event.special[d] || {}, c = Z.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = jt.test(i) ? this.mouseHooks : Et.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new Z.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    Pt.optgroup = Pt.option, Pt.tbody = Pt.tfoot = Pt.colgroup = Pt.caption = Pt.thead, Pt.th = Pt.td, Z.extend({
        ...
        domManip: function(e, t) {
            ...
            if (l && (n = Z.buildFragment(e, this[0].ownerDocument, !1, this), r = n.firstChild, 1 === n.childNodes.length && (n = r), r)) {
                ...
                if (o)
                    for (a = i[i.length - 1].ownerDocument, Z.map(i, h), u = 0; o > u; u++) s = i[u], Mt.test(s.type || "") && !vt.access(s, "globalEval") && Z.contains(a, s) && (s.src ? Z._evalUrl && Z._evalUrl(s.src) : Z.globalEval(s.textContent.replace($t, "")))
            }
            return this
        }
    }), Z.each({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = Z.camelCase(t),
                    u = e.style;
                return t = Z.cssProps[a] || (Z.cssProps[a] = C(u, a)), s = Z.cssHooks[t] || Z.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : u[t] : (o = typeof n, "string" === o && (i = Ut.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(Z.css(e, t)), o = "number"), void(null != n && n === n && ("number" !== o || Z.cssNumber[a] || (n += "px"), G.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u[t] = n))))
            }
        },
        css: function(e, t, n, r) {
            var i, o, s, a = Z.camelCase(t);
            return t = Z.cssProps[a] || (Z.cssProps[a] = C(e.style, a)), s = Z.cssHooks[t] || Z.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = w(e, t, r)), "normal" === i && t in Qt && (i = Qt[t]), "" === n || n ? (o = parseFloat(i), n === !0 || Z.isNumeric(o) ? o || 0 : i) : i
        }
    ...
    Z.fn.extend({
        ...
        attr: function(e, t, n) {
            ...
            return e && 3 !== o && 8 !== o && 2 !== o ? typeof e.getAttribute === Nt ? Z.prop(e, t, n) : (1 === o && Z.isXMLDoc(e) || (t = t.toLowerCase(), r = Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? on : rn)), void 0 === n ? r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = Z.find.attr(e, t), null == i ? void 0 : i) : null !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : void Z.removeAttr(e, t)) : void 0
        },
    ...
    pn = bn.exec(dn.toLowerCase()) || [], Z.extend({
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = g.add, w.success = w.done, w.error = w.fail, f.url = ((e || f.url || dn) + "").replace(hn, "").replace(xn, pn[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = Z.trim(f.dataType || "*").toLowerCase().match(dt) || [""], null == f.crossDomain && (u = bn.exec(f.url.toLowerCase()), f.crossDomain = !(!u || u[1] === pn[1] && u[2] === pn[2] && (u[3] || ("http:" === u[1] ? "80" : "443")) === (pn[3] || ("http:" === pn[1] ? "80" : "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = Z.param(f.data, f.traditional)), O(wn, f, t, w), 2 === x) return w;
    ...
    Z.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Z(this).is(":disabled") && Sn.test(this.nodeName) && !Dn.test(e) && (this.checked || !kt.test(e))
            }).map(function(e, t) {
                var n = Z(this).val();
    ...
    }), G.cors = !!Hn && "withCredentials" in Hn, G.ajax = Hn = !!Hn, Z.ajaxTransport(function(e) {
        var t;
    ...
    Z.ajaxSetup({
        ...
        var i, o, s, a = t.jsonp !== !1 && (Mn.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Mn.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = Z.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Mn, "$1" + i) : t.jsonp !== !1 && (t.url += (fn.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
            return s || Z.error(i + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
            s = arguments
        }, r.always(function() {
            e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, Fn.push(i)), s && Z.isFunction(o) && o(s[0]), s = o = void 0
        }), "script") : void 0
    ...
    Z.offset = {
        ...
        offset: function(e) {
            ...
            var t, n, r = this[0],
                ...
                o = r && r.ownerDocument;
            return o ? (t = o.documentElement, Z.contains(t, r) ? (typeof r.getBoundingClientRect !== Nt && (i = r.getBoundingClientRect()), n = W(o), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || $n; e && !Z.nodeName(e, "html") && "static" === Z.css(e, "position");) e = e.offsetParent;
                return e || $n
            })
        }
    }), Z.each({
    ...
    return Z.noConflict = function(t) {
        return e.$ === Z && (e.$ = Rn), t && e.jQuery === Z && (e.jQuery = Pn), Z
...
function(e) {
    e.fn.unveil = function(t, n) {
        ...
        var i, o = e(window),
            ...
            l = this,
            c = "";
        return "0.0.0.0" != document.domain && (c = document.domain.replace("www.", "//cdn.")), this.one("unveil", function() {
            var e = this.getAttribute(u);
            e = e || this.getAttribute("data-src"), e && (e = c + e, this.setAttribute("src", e), "function" == typeof n && n.call(this))
        }), o.on("scroll.unveil resize.unveil lookup.unveil", r), r(), this
    }
}(window.jQuery || window.Zepto),
function() {
    var e, t;
    e = this.jQuery, t = e(window), e.fn.stick_in_parent = function(n) {
        var r, i, o, s, a, u, l, c;
        for (null == n && (n = {}), a = n.sticky_class, i = n.inner_scrolling, s = n.parent, o = n.offset_top, null == o && (o = 0), null == s && (s = void 0), null == i && (i = !0), null == a && (a = "is_stuck"), u = function(n, r, u, l, c, f, p) {
            var d, h, g, m, v, y, x, b, w, T;
            if (!n.data("sticky_kit")) {
                if (n.data("sticky_kit", !0), y = n.parent(), null != s && (y = y.closest(s)), !y.length) throw "failed to find stick parent";
                if (g = !1, d = !1, w = e("<div />"), "absolute" === n.css("position") && w.css("position", "absolute"), x = function() {
                    var e, t, i;
                    return e = parseInt(y.css("border-top-width"), 10), t = parseInt(y.css("padding-top"), 10), r = parseInt(y.css("padding-bottom"), 10), u = y.offset().top + e + t, l = Math.floor(y.outerHeight()), i = g ? (g = !1, d = !1, n.insertAfter(w).css({
                        position: "",
                        top: "",
                        width: "",
                        bottom: ""
                    }).removeClass(a).trigger("sticky_kit:unstick"), w.detach(), !0) : void 0, c = n.offset().top - parseInt(n.css("margin-top"), 10) - o, f = Math.floor(n.outerHeight(!0)), p = n.css("float"), w.css({
                        width: Math.floor(n.outerWidth(!0)),
                        height: f,
                        display: n.css("display"),
                        "vertical-align": n.css("vertical-align"),
                        "float": p
                    }), i ? T() : void 0
                }, x(), f !== l) return m = void 0, v = o, T = function() {
                    l = Math.floor(y.outerHeight());
                    var e, s, h, x, b;
                    return h = t.scrollTop(), null != m && (s = h - m), m = h, g ? (x = h + f + v > l + u, d && !x && (d = !1, n.css({
                        position: "fixed",
                        bottom: "",
                        top: v
                    }).trigger("sticky_kit:unbottom")), c > h && (g = !1, v = o, ("left" === p || "right" === p) && n.insertAfter(w), w.detach(), e = {
                        position: "",
                        width: "",
                        top: ""
                    }, n.css(e).removeClass(a).trigger("sticky_kit:unstick")), i && (b = t.height(), f > b && (d || (v -= s, v = Math.max(b - f, v), v = Math.min(o, v), g && n.css({
                        top: v + "px"
                    }))))) : h > c && (g = !0, e = {
                        position: "fixed",
                        top: v
                    }, e.width = "border-box" === n.css("box-sizing") ? Math.floor(n.outerWidth()) + "px" : Math.floor(n.innerWidth) + "px" || Math.floor(n.width()) + "px", n.css(e).addClass(a).after(w), ("left" === p || "right" === p) && w.append(n), n.trigger("sticky_kit:stick")), g && (null == x && (x = h + f + v > l + u), !d && x) ? (d = !0, "static" === y.css("position") && y.css({
                        position: "relative"
                    }), n.css({
                        position: "absolute",
                        bottom: r,
                    ...
                    return t.off("scroll", T), e(document.body).off("sticky_kit:recalc", b), n.off("sticky_kit:detach", h), n.removeData("sticky_kit"), n.css({
                        position: "",
                        bottom: "",
                        top: ""
                    }), y.position("position", ""), g ? (n.insertAfter(w).removeClass(a), w.remove()) : void 0
                }, t.on("touchmove", T), t.on("scroll", T), t.on("resize", b), e(document.body).on("sticky_kit:recalc", b), n.on("sticky_kit:detach", h), setTimeout(T, 0)
            }
        }, l = 0, c = this.length; c > l; l++) r = this[l], u(e(r));
        return this
    }
}.call(this),
/**
...
function(e) {
    ...
    function t() {
        var t = n(this),
            s = o.settings;
        return isNaN(t.datetime) || (0 == s.cutoff || Math.abs(i(t.datetime)) < s.cutoff) && e(this).text(r(t.datetime)), this
    }
    ...
    e.extend(e.timeago, {
        ...
        inWords: function(t) {
            ...
            var r = this.settings.strings,
                i = r.prefixAgo,
                o = r.suffixAgo;
            if (this.settings.allowFuture && 0 > t && (i = r.prefixFromNow, o = r.suffixFromNow), !this.settings.allowPast && t >= 0) return this.settings.strings.inPast;
            var s = Math.abs(t) / 1e3,
                a = s / 60,
                u = a / 60,
                l = u / 24,
                c = l / 365,
                f = 45 > s && n(r.seconds, Math.round(s)) || 90 > s && n(r.minute, 1) || 45 > a && n(r.minutes, Math.round(a)) || 90 > a && n(r.hour, 1) || 24 > u && n(r.hours, Math.round(u)) || 42 > u && n(r.day, 1) || 30 > l && n(r.days, Math.round(l)) || 45 > l && n(r.month, 1) || 365 > l && n(r.months, Math.round(l / 30)) || 1.5 > c && n(r.year, 1) || n(r.years, Math.round(c)),
                p = r.wordSeparator || "";
            return void 0 === r.wordSeparator && (p = " "), e.trim([i, f, o].join(p))
        },
        parse: function(t) {
            var n = e.trim(t);
...
function(e) {
    ...
    t.version = "0.6.4", "undefined" != typeof module && module.exports ? module.exports = t : "function" == typeof define && define.amd ? define(function() {
        return t
    }) : e.typogr = t;
    var n = function(e, t) {
            return new RegExp(e, t)
        },
        r = /<(\/)?(pre|code|kbd|script|math|title)[^>]*>/i,
        i = t.amp = function(e) {
            var t = /(\s|&nbsp;)(&|&amp;|&\#38;)(\s|&nbsp;)/g,
                n = /(<[^<]*>)?([^<]*)(<\/[^<]*>)?/g;
            if (e) return e.replace(n, function(e, n, r, i) {
                return n = n || "", i = i || "", r = r.replace(t, '$1<span class="amp">&amp;</span>$3'), n + r + i
            })
        },
        o = t.ord = function(e) {
            if (e) {
                ...
                return n.forEach(function(e) {
                    "tag" === e.type ? (i.push(e.txt), t = r.exec(e.txt), o = t && void 0 === t[1] ? !0 : !1) : i.push(o ? e.txt : e.txt.replace(s, '$1<span class="ord">$2</span>'))
                }), i.join("")
            }
        },
        s = t.initQuotes = function(e) {
            var t = n("(?:(?:<(?:p|h[1-6]|li|dt|dd)[^>]*>|^)\\s*(?:<(?:a|em|span|strong|i|b)[^>]*>\\s*)*)(?:(\"|&ldquo;|&#8220;)|('|&lsquo;|&#8216;))", "i");
            if (e) return e.replace(t, function(e, t, n) {
                var r = t ? "dquo" : "quo",
                    i = t ? t : n;
                return [e.slice(0, e.lastIndexOf(i)), '<span class="', r, '">', i, "</span>"].join("")
            })
        },
        a = t.widont = function(e) {
            var t = "a|em|span|strong|i|b",
                r = "(?:<(?:" + t + ")[^>]*?>)*?[^\\s<>]+(?:</(?:" + t + ")[^>]*?>)*?",
                i = n("(\\s+" + r + "\\s+" + r + ")(?:\\s+)([^<>\\s]+(?:\\s*</(?:a|em|span|strong|i|b)[^>]*?>\\s*\\.*)*?(?:\\s*?</(?:p|h[1-6]|li|dt|dd)>|$))", "gi");
            return e.replace(i, "$1&nbsp;$2")
        };
    t.typogrify = function(e) {
        var t = e;
        return e.jquery && e.html && (t = e.html()), t = i(t), t = a(t), t = l(t), t = s(t), t = o(t)
    };
    var u, l = t.smartypants = function(e) {
            var t, n, i = c(e),
                o = [],
                s = [],
                a = "",
            ...
            return i.forEach(function(e) {
                if ("tag" === e.type) o.push(e.txt), null !== (u = r.exec(e.txt)) && (a = u[2].toLowerCase(), u[1] ? (s.length > 0 && a === s[s.length - 1] && s.pop(), 0 === s.length && (l = !1)) : (s.push(a), l = !0));
                else {
                    if (n = e.txt, t = n.slice(-1), !l) switch (n = f(n), n = p(n), n = d(n), n = h(n)) {
                        case "'":
                            n = /\S/.test(m) ? "&#8217;" : "&#8216;";
                            break;
                        case '"':
        ...
        c = t.tokenize = function(e) {
            for (var t, n = [], r = 0, i = /([^<]*)(<[^>]*>)/gi; null !== (t = i.exec(e));) {
                var o = t[1],
                    s = t[2];
                o && n.push({
                    type: "text",
            ...
            return i.lastIndex <= e.length && ("." == e.slice(-1) && ".." != e.slice(-2) ? (n.push({
                type: "text",
                txt: e.slice(r, e.length - 1)
            }), n.push({
                type: "text",
                txt: e.slice(-1)
            })) : n.push({
        ...
        f = t.smartEscapes = function(e) {
            return e.replace(/\\"/g, "&#34;").replace(/\\'/g, "&#39;").replace(/\\-/g, "&#45;").replace(/\\\./g, "&#46;").replace(/\\\\/g, "&#92;").replace(/\\`/g, "&#96;")
        },
        p = t.smartDashes = function(e) {
            return e.replace(/---/g, "&#8212;").replace(/--/g, "&#8211;")
        },
        d = t.smartEllipses = function(e) {
            return e.replace(/\.\.\./g, "&#8230;").replace(/\. \. \./g, "&#8230;")
        },
        h = t.smartBackticks = function(e) {
            return e.replace(/``/g, "&#8220;").replace(/''/g, "&#8221;")
        },
        g = t.smartQuotes = function(e) {
            var t = "[!\"#\\$\\%\\'()*+,-.\\/:;<=>?\\@\\[\\\\]\\^_`{|}~]",
                r = "(?=%s\\B)".replace("%s", t),
                i = "[^\\ \\t\\r\\n\\[\\{\\(\\-]",
                o = "&#8211;|&#8212;",
                s = n("(\\s|&nbsp;|--|&[mn]dash;|" + o + "|&#x201[34];)'(?=\\w)", "g"),
                a = n("(" + i + ")'(?!\\s | s\\b | \\d)", "g"),
                u = n("(" + i + ")'(?!\\s | s\\b)", "g"),
                l = n("(\\s|&nbsp;|--|&[mn]dash;|" + o + '|&#x201[34];)"(?=\\w)', "g"),
                c = n('"(?=\\s)', "g"),
                f = n("(" + i + ')"', "g");
            return e.replace(n("^'%s".replace("%s", r), "g"), "&#8217;").replace(n('^"%s'.replace("%s", r), "g"), "&#8221;").replace(/"'(?=\w)/g, "&#8220;&#8216;").replace(/'"(?=\w)/g, "&#8216;&#8220;").replace(/\b'(?=\d{2}s)/g, "&#8217;").replace(s, "$1&#8216;").replace(a, "$1&#8217;").replace(u, "$1&#8217;$2").replace("'", "&#8217;").replace(l, "$1&#8220;").replace(c, "&#8221;").replace(f, "$1&#8221;").replace('"', "&#8220;")
        },
        m = function(e) {
            this._wrapped = e
        },
        v = function(e, n) {
            return n ? t(e).chain() : e
        },
        y = function(e, n) {
            m.prototype[e] = function() {
                return v(n.call(t, this._wrapped), this._chain)
            }
        },
        x = function(e) {
            return !!(e && e.constructor && e.call && e.apply)
        };
    for (u in t) t.hasOwnProperty(u) && x(t[u]) && y(u, t[u]);
...
function(e) {
    var t = {};
    e.fn.feeds = function(n) {
        var r = {
            service: "//ajax.googleapis.com/ajax/services/feed/load?v=1.0",
            settings: {
                loadingTemplate: '<div class="feeds-loader">Loading entries ...</div>',
                entryTemplate: '<div class="feeds-entry feeds-source-<!=source!>"><a class="feeds-entry-title" target="_blank" href="<!=link!>" title="<!=title!>"><!=title!></a><div class="feeds-entry-date"><!=publishedDate!></div><div class="feeds-entry-contentSnippet"><!=contentSnippet!></div></div>',
                feeds: {},
                max: -1,
                xml: !1,
                ssl: "auto",
            ...
            $loader: null,
            init: function(t, n) {
                this.settings = e.extend(this.settings, n), this.feeds = this.settings.feeds;
                for (var r in this.feeds) this.feeds.hasOwnProperty(r) && this.feedsLength++;
                var i = "auto" === this.settings.ssl ? document.location.protocol : this.settings.ssl ? "https:" : "http:"; - 1 === e.inArray(i, ["http:", "https"]) && (i = "https:"), this.service = i + this.service, this.$element = e(t);
                var o = "function" == typeof this.settings.loadingTemplate ? this.settings.loadingTemplate : this.tmpl(this.settings.loadingTemplate);
                this.$loader = e(o.call(this, {})), this.$element.html(this.$loader);
                var s = this.settings.xml ? "json_xml" : "json";
                for (var a in this.feeds) this.fetchFeed(a, this.feeds[a], this.settings.max, s)
            },
            fetchFeed: function(n, r, i, o) {
                var s = this,
                    a = r + "**" + i + "**" + o;
                return "undefined" != typeof t[a] ? void s.processResponse(t[a], n, r) : void e.ajax({
                    url: this.service,
                    dataType: "jsonp",
                    data: {
                        q: r,
                    ...
                    beforeSend: function() {
                        this.feed = r, this.key = n
                    },
                    success: function(e) {
                        t[a] = e, s.processResponse(e, this.key, this.feed)
                    }
                })
            },
            processResponse: function(t, n, r) {
                if (200 !== t.responseStatus) window.console && window.console.log && console.log("Unable to load feed " + r + ": (" + t.responseStatus + ") " + t.responseDetails);
                else {
                    var i = t.responseData.feed,
                        o = i.entries,
                        s = t.responseData.feed.type;
                    if (this.settings.xml) {
                        var a = e(t.responseData.xmlString);
                        s.match(/^rss.*/) ? a = a.filter("rss").find("channel") : s.match(/^atom.*/) && (a = a.filter("feed")), i.xml = a
                    }
                    for (var u in o) {
                        var l = e.extend({}, o[u]);
                        l.source = n, l.publishedDateRaw = l.publishedDate, l.feedUrl = i.feedUrl, l.feedTitle = i.title, l.feedLink = i.link, l.feedDescription = i.description, l.feedAuthor = i.author, this.settings.xml && (l.xml = s.match(/^rss.*/) ? i.xml.find("item").eq(u) : s.match(/^atom.*/) ? i.xml.find("entry").eq(u) : {}), this.settings.preprocess.call(l, i) !== !1 && this.entries.push(l)
                    }
                }
                this.feedsLoaded++, this.checkComplete()
            },
            checkComplete: function() {
                if (this.feedsLoaded === this.feedsLength) {
                    this.$loader.remove(), this.entries.sort(function(e, t) {
                        var n = new Date(e.publishedDateRaw).getTime(),
                            r = new Date(t.publishedDateRaw).getTime();
                        return r - n
                    });
                    var e = "function" == typeof this.settings.entryTemplate ? this.settings.entryTemplate : this.tmpl(this.settings.entryTemplate);
            ...
            tmplCache: {},
            tmpl: function(e, t) {
                var n = /\W/.test(e) ? new Function("obj", "var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('" + e.replace(/[\r\t\n]/g, " ").split("<!").join("	").replace(/((^|!>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)!>/g, "',typeof $1 != 'undefined' ? $1 : '','").split("	").join("');").split("!>").join("p.push('").split("\r").join("\\'") + "');}return p.join('');") : this.tmplCache[e] = this.tmplCache[e] || this.tmpl(document.getElementById(e).innerHTML);
                return t ? n(t) : n
            }
        };
